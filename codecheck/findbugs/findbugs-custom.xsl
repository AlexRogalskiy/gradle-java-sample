  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <p>Produced using <a href="http://findbugs.sourceforge.net">FindBugs</a>
              ...
              <table cellpadding="5" cellspacing="2"
                ...
                <xsl:for-each select="$unique-catkey">
                  ...
                  <tr class="{$styleclass}">
                    ...
                    <td align="right">
                      <xsl:value-of select="count(/BugCollection/BugInstance[@category=$catkey])"/>
                    </td>
                  </tr>
                </xsl:for-each>
                ...
                <tr class="{$styleclass}">
                  ...
                  <td align="right">
                    <b>
                      <xsl:value-of select="count(/BugCollection/BugInstance)"/>
                    </b>
                  </td>
                </tr>
              </table>
